...
export const LEVELS_BETA = [
  ...
  lvl({ name: 'STACKED', par: 3, exit: { x: 660, y: 120 },
    platforms: [floor(0, 180), plat(280, 110), plat(420, 110), plat(560, 110), plat(470, 336, 'fake'), plat(470, 300)],
  ...
  lvl({ name: 'OVERCLOCK', par: 3, exit: { x: 670, y: 250 },
    platforms: [floor(0, 140), { x: 220, y: 320, w: 96, h: 16, type: 'shifting', pathIndex: 0 }, { x: 400, y: 280, w: 96, h: 16, type: 'shifting', pathIndex: 1 }, plat(560, 250)],
  ...
  lvl({ name: 'CHAOS_1', par: 4, exit: { x: 670, y: 300 },
    ...
    hazards: [{ x: 440, y: 70, type: 'ceiling_trap', dropDistance: 50, armProximity: 55 }, ss(500, 264)] }),
  ...
  lvl({ name: 'NEEDLE_X', par: 4, exit: { x: 644, y: 250 },
    platforms: [floor(0, 160), plat(210, 336, 'fake', 46), plat(210, 300, 'solid', 46),
