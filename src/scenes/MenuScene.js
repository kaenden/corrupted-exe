...
export class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Main menu — minimal text (Q-style): clean labels, hover draws an accent underline + ▸◂ marks
    this._menuBtn(206, 'CAMPAIGN', () => this._go(), 0x00ff88, 0);
    this._menuBtn(250, 'ESCAPE', () => this.scene.start('BackdoorScene'), 0x2affff, 90);
    this._menuBtn(294, 'SHOP', () => this.scene.start('ShopScene'), 0xffd24a, 180);
    this._menuBtn(338, 'SETTINGS', () => this.scene.start('SettingsScene'), 0x9b8aff, 270);
