...
import { textButton, neonPanel, hdCamera, addScanlines, TXT } from '../ui/widgets.js';
...
export class EscapeOverScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    neonPanel(this, cx, cy - 6, 380, 260, 0xff2a4d);
    ...
    textButton(this, cx, cy + 70, '↻  ESCAPE AGAIN', () => this.scene.start('EscapeScene'),
      { size: '17px', bg: '#0e1f2a', color: '#2affff', padX: 22, padY: 9 });
    textButton(this, cx - 76, cy + 112, 'UPGRADES', () => this.scene.start('BackdoorScene'), { size: '13px' });
    textButton(this, cx + 76, cy + 112, 'MENU', () => this.scene.start('MenuScene'), { size: '13px' });
